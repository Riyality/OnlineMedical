		...
		<c:forEach var="med" items="${MedicineList}">
			...
			<tr>
				...
				<td data-th="Movie Title"><a
					href="updatemedicine?medicineId=${med.medicineId}&medicineName=${med.medicineName}&rate=${med.rate}&manufacturer=${med.manufacturer}&expiryDate=${med.expiryDate}"><i class="fa-solid fa-pen-to-square"></i></a></td>

<td>
				<a class="btn btn-sm bg-danger-light" href="#"
					onclick="confirmDelete(${med.medicineId});"> 
...
<script>
    function confirmDelete(medicineId) {
        if (confirm('Are you sure you want to delete this record?')) {
            window.location.href = 'deletes?medicineId=' + medicineId;
        }
    }
</script>
